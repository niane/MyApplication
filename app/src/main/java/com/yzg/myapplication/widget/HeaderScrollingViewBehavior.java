...
/**
 * Created by yzg on 2017/1/19.
 */

abstract class HeaderScrollingViewBehavior extends com.yzg.myapplication.widget.ViewOffsetBehavior<View> {
...
//            }
    ...
    final int getOverlapPixelsForOffset(final View header) {
        return mOverlayTop == 0 ? 0 : MathUtil.constrain(
